const storeListenedContentTypesService = ({ store }) => ({
   ...
   * @returns {Promise<string[]>} - ContentType names.
   */
  setListenedContentTypes: async ({ contentTypes = [] }) => {
...
export default storeListenedContentTypesService