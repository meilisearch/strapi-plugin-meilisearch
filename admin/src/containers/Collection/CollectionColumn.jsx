...
import FilterableAttributesPanel from '../../components/FilterableAttributesPanel'
...
const CollectionColumn = ({
  ...
  const colSpan = 6 + (canCreate || canDelete ? 1 : 0) + (canUpdate ? 1 : 0)
  ...
  return (
    <>
      ...
      {entry.indexed && (
        <Tr>
          <Td colSpan={colSpan} background="neutral100">
            <FilterableAttributesPanel
              contentType={entry.contentType}
              indexUid={entry.indexUid}
            />
          </Td>
        </Tr>
      )}
